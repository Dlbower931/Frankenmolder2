...
import sys
# --- Wrap entire script logic in a try block ---
try:
    try:
        import rospy
    ...
    def control_heater(zone_id, turn_on):
        ...
        current_pin_state = heater_pin_states.get(zone_id) # Use get for safety
    ...
    if __name__ == '__main__':
        ...
        # --- FIX: Moved finally block outside inner try/except ---
        finally:
...
# --- Top-level exception handler (Corrected Indentation) ---
